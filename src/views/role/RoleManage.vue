    ...
    <el-container class="container">
      <el-aside>
        <div class="links flex-around">
          <el-link type="primary" @click="$navigator('createRole')">创建角色</el-link>
      ...
      <el-main>
        <el-title level="2">
          <span>所有者</span>
          <template slot="desc">系统默认角色,默认具有企业所有功能权限和全部数据可见范围</template>
        </el-title>
...
export default {
  ...
  methods: {
    ...mapActions(['getRoleGroupMenuListAct']),
    async getMenuList() {
